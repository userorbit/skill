...
.hero .sub{font-size:18px;color:var(--muted);max-width:640px;margin:0 auto 10px}
...
.band{padding:72px 0}
.hero-band{padding:20px 0 84px;background:radial-gradient(closest-side at 50% 40%,rgba(124,77,255,.18),transparent)}
