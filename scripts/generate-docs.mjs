...
const css = `
:root{
  --bg:#ffffff;--bg-soft:#f6f6f8;--ink:#0b0b0e;--text:#3f3f46;--muted:#67676f;--faint:#94949c;
  --line:#e7e7ec;--line-strong:#cfcfd6;
  --brand:#4f30e8;--brand-bright:#6d4dff;--peri:#a9a2ff;
  --dark:#0e0e13;--dark-2:#17171d;--dark-line:#2a2a33;
...
h1{font-size:clamp(34px,5.4vw,56px);line-height:1.05;letter-spacing:-.035em}
h2{font-size:clamp(24px,3vw,32px);letter-spacing:-.025em;line-height:1.2}
h3{font-size:19px;letter-spacing:-.01em}
.hl{background:linear-gradient(100deg,var(--brand) 10%,var(--peri) 90%);-webkit-background-clip:text;background-clip:text;color:transparent}
...
header.site{position:sticky;top:0;z-index:20;background:color-mix(in srgb,var(--bg) 88%,transparent);backdrop-filter:blur(14px);border-bottom:1px solid var(--line)}
...
.nav a.cta{background:var(--ink);color:#fff;font-family:var(--display);font-weight:500;font-size:14px;padding:8px 16px;border-radius:10px;box-shadow:0 0 0 2px color-mix(in srgb,var(--brand) 30%,transparent)}
.nav a.cta:hover{text-decoration:none;box-shadow:0 0 0 3px color-mix(in srgb,var(--brand) 45%,transparent)}
@media(max-width:640px){.nav a.item{display:none}}

.btn{display:inline-flex;align-items:center;gap:8px;font-family:var(--display);font-weight:500;font-size:15.5px;padding:12px 24px;border-radius:12px}
.btn:hover{text-decoration:none}
.btn-primary{background:var(--ink);color:#fff;box-shadow:0 0 0 1px var(--ink),0 0 0 4px color-mix(in srgb,var(--brand) 28%,transparent),0 12px 28px -12px color-mix(in srgb,var(--brand) 60%,transparent)}
.btn-primary:hover{box-shadow:0 0 0 1px var(--ink),0 0 0 5px color-mix(in srgb,var(--brand) 42%,transparent),0 14px 30px -10px color-mix(in srgb,var(--brand) 70%,transparent)}
.btn-secondary{background:var(--bg);color:var(--ink);border:1px solid var(--line-strong)}
.btn-secondary:hover{border-color:var(--ink)}

.hero{padding:88px 0 72px;text-align:center}
.hero .orbit-mark{margin:0 auto 28px}
...
.prism{position:relative;isolation:isolate;overflow:hidden;background:
  repeating-linear-gradient(105deg,rgba(255,255,255,.13) 0 2px,transparent 2px 110px),
  repeating-linear-gradient(99deg,rgba(255,255,255,.07) 0 1px,transparent 1px 30px),
  linear-gradient(112deg,#180f4e 0%,#3a1fd0 30%,#7a5cff 55%,#4f30e8 76%,#1b1160 100%)}
...
.prism.teal{background:
  repeating-linear-gradient(105deg,rgba(255,255,255,.14) 0 2px,transparent 2px 120px),
  repeating-linear-gradient(99deg,rgba(255,255,255,.08) 0 1px,transparent 1px 34px),
  linear-gradient(112deg,#083c38 0%,#0f9488 34%,#7ce8da 58%,#0d7a70 80%,#06302c 100%)}
.band{padding:72px 0}

.term{background:var(--dark);border:1px solid rgba(255,255,255,.09);border-radius:var(--radius);box-shadow:0 30px 70px -30px rgba(8,4,40,.6);padding:24px 26px;overflow-x:auto;text-align:left}
...
.card{position:relative;background:var(--bg);border:1px solid var(--line);border-radius:var(--radius);padding:22px;display:block;color:var(--text);transition:border-color .15s,transform .15s,box-shadow .15s}
.card:hover{border-color:var(--ink);text-decoration:none;transform:translateY(-2px);box-shadow:0 12px 28px -18px rgba(11,11,14,.25)}
...
.prompts li{border:1px solid var(--line);border-radius:12px;padding:14px 18px 14px 44px;margin-bottom:10px;font-size:15px;color:var(--ink);position:relative;background:var(--bg)}
...
.post-cta .btn-light{background:#fff;color:var(--ink);box-shadow:0 10px 24px -10px rgba(0,0,0,.4)}
...
<link rel="icon" href="data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><circle cx=%2250%22 cy=%2250%22 r=%2242%22 fill=%22%234f30e8%22/><circle cx=%2250%22 cy=%2250%22 r=%2217%22 fill=%22white%22/></svg>">
